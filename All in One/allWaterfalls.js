...
const KYjson = (() => {
    ...
    $.ajax({
        'async': false,
        'global': false,
        'url': "../Kentucky/Kentucky Waterfalls.json", //Json file location
        'dataType': "json",
        'success': function(data) {
        json = data;
    }
...
const WAjson = (() => {
    ...
    $.ajax({
        'async': false,
        'global': false,
        'url': "../Washington/Washington Waterfalls.json", //Json file location
        'dataType': "json",
        'success': function(data) {
        json = data;
    }
...
var waWaterfalls = WAjson.waterfalls;
